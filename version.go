...
// linker flag:
//   $> go build -ldflags "-X github.com/dihedron/osquery-snaps/main.GitHash=$(hash)"
...
//   $> nm ./cloudctl-docs | grep GitHash
//   00000000015db9c0 b github.com/dihedron/osquery-snaps/main.GitHash
